...
public class upload2 extends AppCompatActivity implements  View.OnClickListener, AdapterView.OnItemSelectedListener {
    private static final int PICK_IMAGE_REQUEST = 234;
    //private ImageView imageView;
    private Button buttonChoose2, buttonUpload2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //mref.setValue("Hi");
        spinner2 = (Spinner) findViewById(R.id.Year2);
        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(getApplicationContext(), android.R.layout.simple_list_item_1,getResources().getStringArray(R.array.year));
        adapter2.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
        spinner2.setAdapter(adapter2);
        spinner2.setOnItemSelectedListener((AdapterView.OnItemSelectedListener) upload2.this);
        //imageView=(ImageView) findViewById(R.id.imageView);
        buttonChoose2 = (Button) findViewById(R.id.buttonChoose2);
        buttonUpload2 = (Button) findViewById(R.id.buttonUpload2);
        dep = findViewById(R.id.department2);
        mtype="Notice";
...
*/
        ...
        buttonChoose2.setOnClickListener((View.OnClickListener) this);
        buttonUpload2.setOnClickListener((View.OnClickListener) this);
    ...
    private void up() {
        ...
        if (filePath != null) {
            ...
            mypath=my+"/"+(dep.getText().toString())+"/"+((mtype)+"/"+(fname.getText().toString()));
            // Uri file = Uri.fromFile(new File("path/to/images/rivers.jpg"));
            //Toast.makeText(this,mypath,Toast.LENGTH_SHORT).show();
            mref=mfirebase.getReference(mypath);
            final StorageReference riversRef = mStorageRef.child(((my)+("/")+(dep.getText().toString())+("/")+(mtype)+("/")+ (fname.getText().toString())+(".pdf")));
