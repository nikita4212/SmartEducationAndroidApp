                ...
                fAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            DocumentReference cf = db.collection("faculty").document(userId);

                            cf.addSnapshotListener(new EventListener<DocumentSnapshot>() {
                                @Override
                                    ...
                                    public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                                        if (task.getResult().exists()) {
                                            ...
                                            finish();
                                                      ...
                                                      {
                                                          Toast.makeText(Login.this, "Your approval is pending....wait till approve.", Toast.LENGTH_SHORT).show();
                                                          progressBar.setVisibility(View.GONE);
